...
class ReorderPolicy(Base):
    ...
    __table_args__ = (
        UniqueConstraint("warehouse_id", "product_id", name="uq_reorder_policy"),
    )
    ...
    preferred_supplier_organization_id: Mapped[int | None] = mapped_column(
        BigInteger, ForeignKey("organization.id")
    )
