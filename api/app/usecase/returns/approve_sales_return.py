...
class ApproveSalesReturnUsecase:
    ...
    def execute(
        ...
        if entity.status != SalesReturnStatus.REQUESTED.value:
        ...
        self.history.create(
            ...
            to_status=SalesReturnStatus.APPROVED.value,
            reason=reason,
            changed_by_account_id=account_id,
        )
        self.outbox.enqueue(
            event_type="sales_return.approved",
            aggregate_type="sales_return",
            aggregate_id=entity.id,
            payload={
                "sales_return_id": entity.id,
                "order_id": entity.order_id,
                "status": SalesReturnStatus.APPROVED.value,
            },
        )
        self.audit.record(
